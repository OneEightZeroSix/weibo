<template>
    ...
    <!-- 登陆成功跳转页 -->
    <input type="hidden" name="url" value="https%3A%2F%2Fm.weibo.cn%2F%3Fjumpfrom%3Dweibocom" id="loginSuccessAddress">
    <!-- 登陆rf标识 -->
    ...
    <section class="avatar-wrapper" id="avatarWrapper">
        <!-- 头像 -->
        <img src="https://passport.weibo.cn/images/weibo/signin/default-avatar_2x.png" onerror="this.src='https://passport.weibo.cn/images/weibo/signin/default-avatar_2x.png';">
    </section>
    <form>
        <section class="box">
            ...
            <div class="input-wrapper">
                ...
                <p class="input-box"><input type="password" placeholder="请输入密码" id="loginPassword" autocomplete="off"
                        style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;"></p>
            </div>
        </section>
        ...
        <div id="verifyCodeWrapper" style="display:none">
            ...
            <!-- 要隐藏添加 hid -->
            <div class="box">
                <input type="text" placeholder="请输入验证码" id="loginVCode" autocomplete="off" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;">
            </div>
        </div>
        ...
        <div id="dVerifyCodeWrapper" style="display:none">
            ...
            <!-- 要隐藏添加 hid -->
            <div class="box">
                <input type="text" name="shieldCode" placeholder="请输入微盾动态码" id="loginDVCode" autocomplete="off" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;">
            </div>
        </div>
    ...
    <p class="label">
        <a href="https://passport.weibo.cn/signin/other?r=https%3A%2F%2Fm.weibo.cn%2F%3Fjumpfrom%3Dweibocom">第三方帐号</a>
    </p>
    <footer class="footer">
        <a href="https://m.weibo.cn/reg/index?&amp;vt=4&amp;wm=3349&amp;wentry=&amp;backURL=https%3A%2F%2Fm.weibo.cn%2F%3Fjumpfrom%3Dweibocom">注册帐号</a><a
            href="https://passport.weibo.cn/forgot/forgot?entry=wapsso&amp;from=0&amp;r=https%3A%2F%2Fm.weibo.cn%2F">忘记密码</a>
    </footer>
</div>
</template>
<script>
...
@font-face {
  ...
  src: url("https://h5s.sinaimg.cn/weibocn/font/wb440.eot?#iefix")
      format("embedded-opentype"),
    url("https://h5s.sinaimg.cn/weibocn/font/wb440.woff") format("woff"),
    url("https://h5s.sinaimg.cn/weibocn/font/wb440.ttf") format("truetype"),
    url("https://h5s.sinaimg.cn/weibocn/font/wb440.svg?#wb440") format("svg");
  font-weight: normal;
  font-style: normal;
}
.nav {
...
.avatar-wrapper {
  ...
  background-image: url("/images/weibo/signin/default-avatar.png");
...
@media only screen and (-webkit-min-device-pixel-ratio: 2) {
  .avatar-wrapper {
    background-image: url("/images/weibo/signin/default-avatar_2x.png");
  }
}
.avatar-wrapper img {
  display: block;
...
@media only screen and (-webkit-min-device-pixel-ratio: 2) {
  .welcome-wrapper {
    background-image: url("/images/weibo/signin/index-pic_2x.png");
  }
}
@media screen and (device-aspect-ratio: 2 / 3) {
  .welcome-wrapper {
...
.welcome-wrapper .btnQQ .icon {
  ...
  background-repeat: no-repeat;
  background-position: 0 0;
  background-image: url("/images/weibo/signin/icon.png");
